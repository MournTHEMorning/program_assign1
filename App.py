    ...
    if (menuAns=="S"):
        ...
        while(rollAgain):
            if(gMod.RougeAccess().getRoleStatus()):
                ...
                rollInput=input(line+Fore.GREEN+"\nROLL for PHYSICAL SKILLS![Input R]: ").upper()
        ...
        #LOSE ENDING - Player gets 6 or less points(from variable score in Game.py)
            ...
            print(breakLine+Fore.YELLOW+"***YOU LOST... PLEASE TRY AGAIN!***"+Fore.RESET)
